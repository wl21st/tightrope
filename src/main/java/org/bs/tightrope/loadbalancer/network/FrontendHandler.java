...
public class FrontendHandler extends SimpleChannelHandler {
  ...
  public FrontendHandler(ChannelGroup channelGroup, ClientSocketChannelFactory factory,
      ServerPool serverPool, Statistics statistics) {
  ...
  public void channelClosed(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
    if (this.outboundChannel != null) {
      if (this.outboundChannel.isConnected()) {
        this.outboundChannel.write(ChannelBuffers.EMPTY_BUFFER)
